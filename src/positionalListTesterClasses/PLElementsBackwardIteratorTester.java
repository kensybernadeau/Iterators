...
import llPositionalList.PositionListElementsBackwardIterator;

public class PLElementsBackwardIteratorTester {
	...
	private static void removeEvenValues(LinkedPositionalList<Integer> list) {
		...
		PositionListElementsBackwardIterator<Integer> iter = new PositionListElementsBackwardIterator(list);
		while (iter.hasNext())
	...
	private static void showList2(String msg, LinkedPositionalList<Integer> list) {
		System.out.print(msg); 
		//Iterator<Integer> iter = list.iterator(); 
		PositionListElementsBackwardIterator<Integer> iter = new PositionListElementsBackwardIterator<Integer>(list);
		while (iter.hasNext())
